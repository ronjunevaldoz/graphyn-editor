 ...
 * runtime-compilation step to crash. It falls back to a fixed, known-good storyboard on any
 * top-level shape mismatch instead of trusting the LLM's JSON shape blindly.
 *
