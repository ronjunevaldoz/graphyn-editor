...
internal fun mascotSubgraph(
    ...
    id = id, mascotDescription = mascotDescription, width = width, height = height, useLlmPromptEnhance = useLlmPromptEnhance,
)

internal typealias MascotPointDirections = com.ronjunevaldoz.graphyn.plugins.shorts.MascotPointDirections

/** @see com.ronjunevaldoz.graphyn.plugins.shorts.mascotPointEditSubgraph */
internal fun mascotPointEditSubgraph(
    id: String,
    editInstruction: String,
    width: Int = SHORTS_WIDTH,
    height: Int = SHORTS_HEIGHT,
) = com.ronjunevaldoz.graphyn.plugins.shorts.mascotPointEditSubgraph(
    id = id, editInstruction = editInstruction, width = width, height = height,
)

/** @see com.ronjunevaldoz.graphyn.plugins.shorts.mascotFlipSubgraph */
internal fun mascotFlipSubgraph(id: String) =
    com.ronjunevaldoz.graphyn.plugins.shorts.mascotFlipSubgraph(id = id)
...
internal fun comparisonPairSubgraph(
    ...
    id = id, pairIndex = pairIndex, width = width, height = height, useKenBurns = useKenBurns, outputPath = outputPath,
)
