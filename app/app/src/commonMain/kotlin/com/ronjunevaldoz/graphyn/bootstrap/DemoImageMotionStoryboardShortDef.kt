 ...
 */
internal fun imageMotionStoryboardShortWorkflow(topic: String) = WorkflowDefinition(
    ...
    nodes = buildList {
        ...
        repeat(STORYBOARD_SCENE_COUNT) { index ->
            ...
            add(NodeRef(
                ...
                subgraph = imageMotionSceneSubgraphDynamic(id = "storyboard-scene-$index", imageCount = STORYBOARD_IMAGES_PER_SCENE),
            ))
