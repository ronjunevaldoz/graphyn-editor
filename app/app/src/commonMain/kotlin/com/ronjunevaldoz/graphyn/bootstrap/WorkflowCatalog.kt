...
enum class WorkflowCatalog(
    ...
    WanImg2Vid("Wan Image to Video", wanImg2VidWorkflow, Media,
        "Animate a still into video with Wan2.2 A14B (MoE) — quality tier, needs >12GB VRAM.", badge = "AI"),
    ...
    ImageShorts("AI Shorts (Image Motion)", imageShortsWorkflow, Media,
        "Generate FLUX keyframes, animate them with Wan camera motion, stitch, caption, and encode.", badge = "AI"),
    ...
    Slideshow("Slideshow", slideshowWorkflow, Media,
        "Render a set of images into a video at a fixed frame rate."),
